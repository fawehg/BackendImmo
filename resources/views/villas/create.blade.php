...
<head>
    ...
    <title>Ajouter une Villa | Tableau de Bord</title>
    ...
    <div class="container">
        ...
        <form action="{{ route('villas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="superficie_jardin" id="superficie_jardin" class="form-control @error('superficie_jardin') is-invalid @enderror" value="{{ old('superficie_jardin') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input type="number" name="chambres" id="chambres" class="form-control @error('chambres') is-invalid @enderror" value="{{ old('chambres') }}" min="0">
                @error('chambres')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="pieces" id="pieces" class="form-control @error('pieces') is-invalid @enderror" value="{{ old('pieces') }}" min="0">
                @error('pieces')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="etages" id="etages" class="form-control @error('etages') is-invalid @enderror" value="{{ old('etages') }}" min="0">
                @error('etages')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="annee_construction" id="annee_construction" class="form-control @error('annee_construction') is-invalid @enderror" value="{{ old('annee_construction') }}" min="1900" max="{{ date('Y') }}">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="meuble" id="meuble" {{ old('meuble') ? 'checked' : '' }}>
                @error('meuble')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="jardin" id="jardin" {{ old('jardin') ? 'checked' : '' }}>
                @error('jardin')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="piscine" id="piscine" {{ old('piscine') ? 'checked' : '' }}>
                @error('piscine')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="piscine_privee" id="piscine_privee" {{ old('piscine_privee') ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="garage" id="garage" {{ old('garage') ? 'checked' : '' }}>
                @error('garage')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="cave" id="cave" {{ old('cave') ? 'checked' : '' }}>
                @error('cave')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="terrasse" id="terrasse" {{ old('terrasse') ? 'checked' : '' }}>
                @error('terrasse')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
