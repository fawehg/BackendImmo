                ...
                @if($villas->count() > 0)
                    @foreach($villas as $villa)
                        <tr>
                            ...
                            <td data-label="Titre">{{ $villa->titre }}</td>
                            <td data-label="Prix">{{ number_format($villa->prix, 2) }} TND</td>
                            <td data-label="Ville">{{ $villa->ville->nom }}</td>
                            <td data-label="Délégation">{{ $villa->delegation->nom }}</td>
                            <td data-label="Superficie">{{ $villa->superficie }} m²</td>
                            <td data-label="Chambres">{{ $villa->chambres }}</td>
                            <td data-label="Actions">
                                <div class="action-buttons">
                                    <a href="{{ route('villas.show', $villa->id) }}" class="btn btn-secondary btn-sm" title="Détails">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('villas.edit', $villa->id) }}" class="btn btn-warning btn-sm" title="Modifier">
