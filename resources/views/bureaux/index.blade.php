...
@section('contents')
    ...
    <div class="container">
        <div class="header-section">
            <h1 class="page-title">Gestion des Bureaux</h1>
            <a href="{{ route('bureaux.create') }}" class="btn btn-primary">
                    ...
                    @if($bureaux->count() > 0)
                        @foreach($bureaux as $bureau)
                            <tr>
                                ...
                                <td data-label="Titre">{{ $bureau->titre }}</td>
                                <td data-label="Prix">{{ number_format($bureau->prix, 2) }} TND</td>
                                <td data-label="Ville">{{ $bureau->ville->nom }}</td>
                                <td data-label="Délégation">{{ $bureau->delegation->nom }}</td>
                                <td data-label="Superficie">{{ $bureau->superficie }} m²</td>
                                <td data-label="Actions">
                                    <div class="action-buttons">
                                        <a href="{{ route('bureaux.show', $bureau->id) }}" class="btn btn-secondary btn-sm" title="Détails">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('bureaux.edit', $bureau->id) }}" class="btn btn-warning btn-sm" title="Modifier">
