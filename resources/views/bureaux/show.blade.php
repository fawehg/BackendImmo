...
<head>
    ...
    <title>Détails du Bureau | Tableau de Bord</title>
    ...
    <div class="profile-container">
        <div class="profile-header">
            <div class="profile-avatar">
                {{ strtoupper(substr($bureau->titre, 0, 1)) }}
            </div>
            <h1>{{ $bureau->titre }}</h1>
        </div>
        ...
        <div class="detail-grid">
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ number_format($bureau->prix, 2) }} TND
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $bureau->superficie_couverte ?? 'Non spécifié' }} m²
                </div>
            </div>
            ...
            <div class="detail-item">
                <div class="detail-label">
                    ...
                    <span>Nombre de bureaux</span>
                </div>
                <div class="detail-value">
                    {{ $bureau->nombre_bureaux ?? 'Non spécifié' }}
                </div>
            </div>
            ...
            <div class="detail-item">
                <div class="detail-label">
                    ...
                    <span>Nombre de toilettes</span>
                </div>
                <div class="detail-value">
                    {{ $bureau->nombre_toilettes ?? 'Non spécifié' }}
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $bureau->environnement->nom ?? 'Non spécifié' }}
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    @if($bureau->caracteristiques->isNotEmpty())
                        <ul>
                            @foreach($bureau->caracteristiques as $caracteristique)
                                <li>{{ $caracteristique->nom }}</li>
                            @endforeach
                        </ul>
                    @else
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $bureau->created_at->format('d/m/Y H:i') }}
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $bureau->updated_at->format('d/m/Y H:i') }}
                </div>
            </div>
        </div>
...
@endif
        ...
        <div class="action-buttons">
            ...
            <form action="{{ route('bureaux.destroy', $bureau->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce bureau ?')">
