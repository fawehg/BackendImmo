...
<head>
  ...
  <style>
    .bg-custom-image {background-image: url('{{ asset("admin_assets/img/handss.jpg") }}');background-size: cover;background-position: center;}
    body {
      display: flex;
  ...
  <div class="container">
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block bg-custom-image"></div>
          <div class="col-lg-7">
            <div class="p-5">
