...
@section('contents')
    ...
    <div class="container">
        <div class="form-header">
            <h1>Ajouter un Étage de Villa</h1>
        </div>

        <form action="{{ route('etagesvillas.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" name="numero_etage" id="numero_etage" class="form-control @error('numero_etage') is-invalid @enderror" value="{{ old('numero_etage') }}">
                @error('numero_etage')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="acces_independant" id="acces_independant" value="1" {{ old('acces_independant') ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="parking_inclus" id="parking_inclus" value="1" {{ old('parking_inclus') ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="number" name="annee_construction" id="annee_construction" class="form-control @error('annee_construction') is-invalid @enderror" value="{{ old('annee_construction') }}">
