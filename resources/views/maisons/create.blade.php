...
<head>
    ...
    <title>Nouvelle Maison | Tableau de Bord</title>
...
<body>
    <div class="form-container">
        <div class="form-header">
            ...
            <p>Remplissez les informations pour créer une nouvelle maison</p>
        </div>
        ...
        <form method="POST" action="{{ route('maisons.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="nombre_chambres" name="nombre_chambres" value="{{ old('nombre_chambres') }}" class="form-input @error('nombre_chambres') input-error @enderror">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="nombre_pieces" name="nombre_pieces" value="{{ old('nombre_pieces') }}" class="form-input @error('nombre_pieces') input-error @enderror">
                    @error('nombre_pieces')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="annee_construction" name="annee_construction" value="{{ old('annee_construction') }}" class="form-input @error('annee_construction') input-error @enderror">
            ...
            <button type="submit" class="btn-submit">
                <i class="fas fa-home"></i> Créer la maison
            </button>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function() {
            // Initialiser Select2 pour les sélecteurs simples
