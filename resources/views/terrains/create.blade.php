...
<head>
    ...
    <title>Ajouter un Terrain | Tableau de Bord</title>
    ...
    <div class="container">
        ...
        <form action="{{ route('terrains.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="surface_constructible" id="surface_constructible" class="form-control @error('surface_constructible') is-invalid @enderror" value="{{ old('surface_constructible') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="permis_construction" id="permis_construction" {{ old('permis_construction') ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="checkbox" name="cloture" id="cloture" {{ old('cloture') ? 'checked' : '' }}>
                @error('cloture')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <select name="types_terrains_id" id="types_terrains_id" class="form-control @error('types_terrains_id') is-invalid @enderror">
                    ...
                    @foreach($types_terrains as $type_terrain)
                        <option value="{{ $type_terrain->id }}" {{ old('types_terrains_id') == $type_terrain->id ? 'selected' : '' }}>{{ $type_terrain->nom }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select name="types_sols_id" id="types_sols_id" class="form-control @error('types_sols_id') is-invalid @enderror">
                    ...
                    @foreach($types_sols as $type_sol)
                        <option value="{{ $type_sol->id }}" {{ old('types_sols_id') == $type_sol->id ? 'selected' : '' }}>{{ $type_sol->nom }}</option>
                    @endforeach
                </select>
                @error('types_sols_id')
                    <div class="invalid-feedback">{{ $message }}</div>
