...
<head>
    ...
    <title>Détails du Terrain | Tableau de Bord</title>
    ...
    <div class="profile-container">
        <div class="profile-header">
            <div class="profile-avatar">
                {{ strtoupper(substr($terrain->titre, 0, 1)) }}
            </div>
            <h1>{{ $terrain->titre }}</h1>
        </div>
        ...
        <div class="detail-grid">
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ number_format($terrain->prix, 2) }} TND
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $terrain->surface_constructible ?? 'Non spécifié' }} m²
                </div>
            </div>
            ...
            <div class="detail-item">
                <div class="detail-label">
                    ...
                    <span>Permis de construction</span>
                </div>
                <div class="detail-value">
                    {{ $terrain->permis_construction ? 'Oui' : 'Non' }}
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $terrain->type_terrain->nom ?? 'Non spécifié' }}
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $terrain->type_sol->nom ?? 'Non spécifié' }}
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $terrain->created_at->format('d/m/Y H:i') }}
                </div>
            </div>
            ...
            <div class="detail-item">
                ...
                <div class="detail-value">
                    {{ $terrain->updated_at->format('d/m/Y H:i') }}
                </div>
            </div>
        </div>
        ...
        @if($terrain->images)
            @php
                $images = is_string($terrain->images) ? json_decode($terrain->images, true) : $terrain->images;
            @endphp
        ...
        <div class="action-buttons">
            <a href="{{ route('terrains.edit', $terrain->id) }}" class="btn btn-primary">
                <i class="fas fa-edit"></i> Modifier
            </a>
            <a href="{{ route('terrains') }}" class="btn btn-secondary">
